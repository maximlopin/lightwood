...
data_test = {'x': [random.randint(-15, 10) for i in range(m)],
        'y': [random.randint(-15, 10) for i in range(m)]}
...
predictor.learn(from_data=df_train, callback_on_iter=iter_function, eval_every_x_epochs=600)
